...
// Country data with approximate positions on a simplified world map (percentages)
const MINING_COUNTRIES = [
  { code: "NG", name: "Nigeria", flag: "🇳🇬", miners: 1847, x: 48, y: 52, color: "#22c55e" },
  { code: "US", name: "United States", flag: "🇺🇸", miners: 412, x: 18, y: 38, color: "#3b82f6" },
  { code: "IN", name: "India", flag: "🇮🇳", miners: 389, x: 72, y: 45, color: "#f97316" },
  { code: "GB", name: "United Kingdom", flag: "🇬🇧", miners: 287, x: 46, y: 30, color: "#ef4444" },
  { code: "GH", name: "Ghana", flag: "🇬🇭", miners: 256, x: 45, y: 52, color: "#eab308" },
  { code: "KE", name: "Kenya", flag: "🇰🇪", miners: 198, x: 58, y: 56, color: "#14b8a6" },
  { code: "ZA", name: "South Africa", flag: "🇿🇦", miners: 176, x: 53, y: 72, color: "#8b5cf6" },
  { code: "PH", name: "Philippines", flag: "🇵🇭", miners: 154, x: 83, y: 48, color: "#06b6d4" },
  { code: "CA", name: "Canada", flag: "🇨🇦", miners: 132, x: 18, y: 26, color: "#ec4899" },
  { code: "DE", name: "Germany", flag: "🇩🇪", miners: 118, x: 50, y: 32, color: "#f59e0b" },
  { code: "BR", name: "Brazil", flag: "🇧🇷", miners: 97, x: 30, y: 62, color: "#10b981" },
  { code: "AE", name: "UAE", flag: "🇦🇪", miners: 89, x: 62, y: 42, color: "#6366f1" },
  { code: "TR", name: "Turkey", flag: "🇹🇷", miners: 76, x: 56, y: 36, color: "#e11d48" },
  { code: "ID", name: "Indonesia", flag: "🇮🇩", miners: 68, x: 82, y: 58, color: "#d946ef" },
  { code: "EG", name: "Egypt", flag: "🇪🇬", miners: 54, x: 55, y: 42, color: "#0ea5e9" },
  { code: "PK", name: "Pakistan", flag: "🇵🇰", miners: 47, x: 68, y: 40, color: "#84cc16" },
];
      ...
      <div className="relative z-10 p-6 md:p-10 max-w-[1400px] mx-auto">
        ...
        >
          {[
            ...
            { icon: Users, label: "Total Miners", value: TOTAL_MINERS.toLocaleString(), sub: "+12% this week" },
            { icon: Zap, label: "ARX Mined Today", value: "847K", sub: "Block reward: 1000" },
            { icon: Activity, label: "Active Now", value: "4,339", sub: "Mining in real-time" },
          ].map((stat, i) => (
            <div
              key={stat.label}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          >
            ...
            {/* Simplified world map using dot grid */}
            <div className="relative w-full aspect-[2/1] min-h-[300px]">
              ...
              >
                {/* Create dot grid for world map feel */}
                {Array.from({ length: 50 }).map((_, row) =>
                  Array.from({ length: 100 }).map((_, col) => {
                    const x = col * 10 + 5;
                    const y = row * 10 + 5;
                    // Simple world shape mask
                    const isLand = isPointOnLand(x / 10, y / 10);
              ...
              {MINING_COUNTRIES.map((country, i) => (
                ...
                >
                  ...
                  {/* Country code label (always visible) */}
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between mb-1">
                        ...
                        <span className="text-xs font-bold text-[#4a9eff] ml-2">
                          {country.miners.toLocaleString()}
                        </span>
                      </div>
                      <div className="h-1.5 bg-white/5 rounded-full overflow-hidden">
                        <motion.div
                          ...
                          style={{
                            background: `linear-gradient(90deg, ${country.color}, ${country.color}88)`,
                          }}
                        />
                      </div>
                    </div>
